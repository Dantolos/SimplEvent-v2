...
function theme_add_files() 
{
     ...
     wp_enqueue_style( 'wp-style-css', get_template_directory_uri() . '/style.css', '', '1.1.65' );
     wp_enqueue_style( 'style-css', get_template_directory_uri() . '/style/build/style.css', '', $scriptversion );
     wp_enqueue_style( 'styles-op', get_template_directory_uri() . '/style/style-op.css', '', '1.0' );
     ...
     //hammerJS
     wp_enqueue_script( 'hammer-js', 'https://cdnjs.cloudflare.com/ajax/libs/hammer.js/2.0.8/hammer.min.js', true );


     //wp_enqueue_script( 'hammer-js', get_template_directory_uri() . '/scripts/libraries/hammerJS/hammer.min.js', false );
