<img src="<?php echo get_template_directory_uri() . '/theme/simplevent-icon.svg'; ?>" alt="" height="80px" style="border-bottom: 2px solid #6b6b6b;margin-top:30px; margin-bottom:10px; width:97.5%;" >
<h2></h2>
<style>
  /*--COLOR--*/
